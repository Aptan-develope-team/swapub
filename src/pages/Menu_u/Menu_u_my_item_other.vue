<template>
<div>
<!-- <body class="item noSearchPage menuPage userPage mItem other"> -->
	<!-- Header -->
	<app-header></app-header>
	<!-- Header END -->
		<div id="main">
		<div class="breadcrumb">
			<i>Swapub</i><i> &#62; Rocky stone</i><i></i><i></i><i></i>
        </div>
        <div class="coverBlock">
            <div>
                <ul class="userInfo">
                    <li class="userPic"><a href="menu_u_myitem_other.html"><img src="../../../static/images/sr_na_img_4.png" alt=""></a></li>
                    <li class="userDetail">
                        <h3 class="userName"><i>我</i>Rocky stone</h3>
                        <p class="userAdd">台北市，台灣</p>
                    </li>
                </ul>
            </div>
            <p class="countPad">
                <span class="countSwap"><i>5</i>筆交換</span>
                <span class="countAssess">
                    <i class="btn_smile">3</i><i class="btn_cry">0</i>
                </span>
				<span><a href="user_attention_other.html" class="iconAttention"></a></span>
				<span>
                    <a class="btn_gr btn_attention action"><i>關注</i><i class="action">取消關注</i></a>
                    <a href="menu_u_myinfo.html" class="btn_gr btn_edit">編輯</a>
                </span>
				<a class="btn_report action">檢舉</a>
            </p>
		...
		<div class="content">
            ...
            <div class="innerCoverBlock">
                ...
                <div>
                    <ul class="userInfo">
                        <li class="userPic"><a href="menu_u_myitem_other.html"><img src="../../../static/images/sr_na_img_4.png" alt=""></a></li>
                        <li class="userDetail">
                            <h3 class="userName">Rocky stone</h3>
                            <p class="userAdd">台北市，台灣</p>
                        </li>
                    </ul>
                </div>
                <p class="countPad">
                    ...
                    <a href="user_attention_other.html" class="iconAttention"></a>
                </p>
                <a class="btn_gr btn_attention action"><i>關注</i><i class="action">取消關注</i></a>
                <a href="menu_u_myinfo.html" class="btn_w btn_edit">編輯</a>
                <a class="btn_report action">檢舉</a>
                <div class="assessMsgPad">
                    <div>
                        <ul class="userInfo oUserMsg">
            ...
            <div class="itemBlock">
                <div class="conBlock marketPad">
                    <h2><i></i>我的物品(<span>10</span>)</h2><h2 class="action"><i></i>物品(<span>10</span>)</h2>
                ...
                <div class="conBlock wishPad">
                    <h2><i></i>我想要(<span>5</span>)</h2><h2 class="action"><i></i>許願牆(<span>5</span>)</h2>
                    <div class="itemPad">
                        <div class="itemBox">
                            <div class="itemTitle">
                                <h4>我想要...</h4>
                        ...
                        <div class="itemBox">
                            ...
                            <div class="itemImg"><img src="../../../static/images/img_swapPad_02.jpg" alt=""></div>
                            <a href="wish_detail.html?c"></a>
                            <div class="itemInfo">
                                <p>類似此素色款式棒球帽，用商品交換，喜歡再留言</p>
                                <p class="timer">1小時前</p>
                        ...
                        <div class="itemBox">
                            ...
                            <div class="itemImg"><img src="../../../static/images/img_swapPad_03.jpg" alt=""></div>
                            <a href="wish_detail.html?c"></a>
                            <div class="itemInfo">
                                <p>類似此素色款式棒球帽，用商品交換，喜歡再留言</p>
                                <p class="timer">1小時前</p>
...
export default {
  ...
  mounted() {
    setTimeout(() => {
      ...
      element.classList.add("noSearchPage", "menuPage", "userPage", "mItem", "other");
