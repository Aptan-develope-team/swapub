<template>
<div>
<!-- <body class="item noSearchPage swap user"> -->
	<!-- Header -->
			...
			<div class="conBlock infoBlock clear">
				<div class="infoPad">
					<dl>
						...
						<dd>
							<ul class="itemImg">
								<li><img src="../../../static/images/ws_it_img_2.jpg" alt=""></li>
				...
				<div class="infoPad">
					<dl class="CG_scorll">
						<dt>
							<ul class="itemTitle">
								<li><h1>【Nikon】類單眼相機</h1></li>
								<li class="itemTag"><a>#Nikon</a></li>
								<li>
									<p>高速 Hybrid AF、內置 EVF、可換鏡頭設計、Full HD 高清拍片、60fps 高速連拍、3 吋 LCD<br>1,010 萬像素<br>視鏡頭而定 x 光學變焦<br>EN-EL15 鋰離子充電池<br>機身 294 Gram<br>機身9成新 無刮痕<br>都在防潮箱保養佳<br>附一顆電池、充電器、原廠皮套、背帶
									</p>
								</li>
							</ul>
						</dt>
		...
		<div class="popContent popDealPad">
            ...
            <form action="menu_t_deal.html">
                <div class="dealDetail">
                    ...
                    <p>電話<input type="text" value="987654321" min="0"></p>
                </div>
...
export default {
  ...
  mounted() {
    setTimeout(() => {
      ...
      element.classList.add("item", "noSearchPage", "swap", "user");
