			...
			<div class="conBlock infoBlock clear">
					...
					<dl>
						<dt>
							<ul class="userInfo user">
								<li class="userPic"><a href="menu_u_myitem_other.html?c"><img src="../../../static/images/ws_user_img_5.png" alt=""></a></li>
						...
						<dd>
							<ul class="itemImg">
								<li><img src="../../../static/images/img_item_09.jpg" alt=""></li>
                        ...
                        <dd>
                            <ul class="editPad action">
                                <li>
                                    ...
                                    <!-- <p class="swapAdd">+<img src="images/icon_addserv.png" alt=""> 免費代購商品一次</p> -->
                                </li>
                            </ul>
                        </dd>
					</dl>
				...
				<div class="infoPad">
					<dl class="CG_scorll">
						<dt>
							<ul class="itemTitle">
								<li><h1>戴爾（Dell）Inspiron 5000二合一：價格549美元</h1></li>
								<li class="itemTag"><a>#Dell</a></li>
								<li>
									<p>這款二合一筆記本電腦僅需549美元，節省250美元，超級合算。該電腦裝有Intel打造品牌的新的第七代晶片、可升級內存（RAM）及容量巨大的硬盤，有著在該價錢下應有的一切。該款電腦質量過硬，灰色的外表並不花俏，但是觸控板很棒，鍵盤打字很舒適，是一個全能的多面手，速度快而又方便攜帶。<br>提供一系列高階功能與優異的配件。<br>滿足您的任何檢視需求︰ 透過 Full HD 顯示器，在寬廣的 15 吋螢幕上享受檢視畫面，是處理專案或串流視訊的完美選擇。<br>作業系統: Windows 10 家庭版。<br>您的備份計劃︰ DVD 光碟機能讓您隨著媒體櫃的成長來擴充儲存空間，並將音樂、電影和檔案儲存到光碟上。<br>滿足您對效能的要求：搭載 4GB GDDR5 獨立顯示卡與最新款 Intel® 第 7 代處理器，當背景正在執行其他程式時，快速敏捷的反應效能可確保您的音樂與影片順暢地播放。</p>
								</li>
							</ul>
						</dt>
						<dd>
		...
		<div class="popContent popDealPad">
            ...
            <form action="menu_t_deal.html">
                ...
                <div class="popCheckPad">
                    ...
                    <input type="submit" class="btn_o btn_sure" value="確定" onclick="deal()">
                </div>
            </form>
        </div>
