				...
				<div class="editList">
					<form action="wish_detail.html" method="get" accept-charset="utf-8">
						<dl class="stepPad action">
							<dt>Step1</dt>
							<dd>
								<p class="editImg"><span><b class="btn_w btn_editimg">編輯</b><i></i></span></p>
							</dd>
						</dl>
						<dl class="stepPad">
							...
							<dd>
								<p class="itemTitle">
									<textarea name="" placeholder="你想許什麼願望 (必填)" required="required" onpropertychange="setHeight(this);" onmouseover="setHeight(this);" onpaste="setHeight(this);" oninput="setHeight(this);" class="reqObj">SAINT LAURENT</textarea>								</p>
								<p class="itemOption itemType action">
									<b>類別&nbsp;(必填)</b><span></span><input type="text" name="" value="女士時尚" placeholder="" required="required" class="reqObj">								</p>
								...
								<p class="itemData">
									<textarea name="" placeholder="描述願望 (必填)" required="required" onpropertychange="setHeight(this);" onmouseover="setHeight(this);" onpaste="setHeight(this);" oninput="setHeight(this);" class="reqObj">只收素色黑白款
僅換物！
一換一為優先～等值或喜歡
僅pchome交換</textarea>
								</p>
								...
								<p class="itemOption"><b>物品地點 (國家)</b><select name=""><option value="">台灣</option></select></p>
								<p class="itemOption"><b>物品地點 (城市)</b><select name=""><option value="">台北市</option></select></p>
							</dd>
						</dl>
 						<dl class="btnPad">
	...
	<div id="popContainer" style="top:-100vh;">
		<div class="popContent popSys popEditImgPad">
			...
			<p>請調整照片位置及大小</p>
			<div class="popImgPad"><i></i><img src="images/ws_it_img_7.jpg" alt=""></div>
