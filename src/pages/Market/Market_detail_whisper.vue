			...
			<div class="conBlock infoBlock clear">
				<div class="infoPad">
					<dl>
						<dt>
							<ul class="userInfo">
								<li class="userPic"><a href="menu_u_myitem.html?c"><img src="../../../static/images/ws_user_img_4.png" alt=""></a></li>
						...
						<dd>
							<ul class="itemImg CGt">
								<li class="imgCont"><img src="../../../static/images/img_item_08.jpg" alt=""></li>
								<li class="imgList action"><img src="../../../static/images/img_item_08.jpg" alt=""></li>
								<li class="imgList"><img src="../../../static/images/img_item_08.jpg" alt=""></li>
							</ul>
						</dd>
		...
		<div class="popContent popEditSwap">
			...
			<form action="swap_item_detail.html?c">
				<div class="popChoImg">
					...
					<p>最多可以提出三個物品</p>
					<div>
						<span class="addImg btn_imgBox getImg"></span>
...
export default {
  components: {
	...
	element.classList.add("item", "noSearchPage", "itemDetail","follow");
	...
	var hideP = function (){
		for(i=0; i<$scLen; i++){
			if(i>2){$scItem.eq(i).fadeOut();}else{$scItem.eq(i).fadeIn();}
		}
	}
	...
	$imgBlock.css({'width': $imgListW * $imgListL});
	var $imgBlockW = $imgBlock.width();
	if($imgBlockW <= $imgMaskW){
		$('.imgMaskW').css({'visibility' : 'hidden'});
	}else {
		$('.imgMaskW').css({'visibility' : 'visible'});
	}
	//編輯按鈕.垃圾桶
